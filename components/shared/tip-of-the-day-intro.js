        ...
        <div className="position-relative subscribeToVip">
            <div className="row">
                ...
                <div className="col-lg-4 col-12"> 
                    ...
                    <div className="row mb-2">
                        <div className="d-grid gap-2 col-8 mx-auto">
                            <a href="https://api.whatsapp.com/send/?phone=254111509962&text&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" className="btn btn-success" type="button" style={{whiteSpace: "nowrap", fontWeight: "bold"}}>WHATSAPP</a>
                        </div>
                    </div>
                </div>
            </div>  
...
export default TipOfTheDayPagesInto;