...
const Over35PageContent = () => {
  return (
    <section className="seo-section">
      <div className="seo-inner">
          <h2>3.5 Goals Predictions</h2>
            <p>
                FreeWinningTips is the most accurate and reliable site for football predictions. We cover predictions for <a href="/yesterdays-free-football-predictions" target="_blank" rel="noopener noreferrer">yesterday</a>, today, and <a href="/tomorrows-free-football-predictions" target="_blank" rel="noopener noreferrer">tomorrow’s matches</a>. Our aim is to save you the time and energy it would take to analyze the fixtures. We have a team of experts who analyze the stats and other factors to deliver the surest predictions.
            </p>
            ...
            <p>
                Our tips are data-based so that you can bet with confidence. We provide our users with free winning tips for today’s matches. Additionally, we have a VIP package that will significantly transform how you bet. Once you subscribe to the <a href="/free-vip-tips-today" target="_blank" rel="noopener noreferrer">VIP/premium package</a>, you’ll get exclusive tips and predictions conveniently delivered to your phone. Subscribe now to get winning tips today.
            </p>
...
export default Over35PageContent;