...
export default function DoubleChance() {
  ...
  let fetch_url = "https://api.pitchpredictions.com/api/fetch_double_chance_free_winning_tips?fixture_date="+todays_date;
    ...
    <div className="free-tips-section">
      ...
      <div className="row mb-4">
        <div className="col-lg-12">         
          ...
          <FreeFixturesDisplayTable gamesfixtures={gamesfixtures} url={router.pathname.substring(1)} title="Double Chance Predictions"/>
        </div>
      </div>
