...
export async function getServerSideProps() {
  ...
  const cachePath = path.join(CACHE_DIR, `doublechance_${fetchDate}.json`);
  ...
  try {
    ...
    const url = `https://develop.pitchpredictions.com/api/fetch_double_chance_free_winning_tips?fixture_date=${fetchDate}`;
    ...
    console.error('[double-chance-page] getServerSideProps error:', err.message);
