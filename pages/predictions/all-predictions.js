...
import AllPredictionsPageContent from '@/components/seo-content/allpredictions-content';
...
export async function getServerSideProps() {
  ...
  try {
    ...
    console.error('[all-predictions-page] getServerSideProps error:', err.message);
