  ...
  return (
    ...
    <div className="free-tips-section">
          ...
          <div className="position-relative subscribeToVip">
              <div className="row">
                  <div className="col-lg-8 col-12">
                      <h1>100% Winning Tip – 100 Sure Football Predictions</h1>
                      <p>
                        Secure your bets with 100% winning tips. Our 100 sure football predictions provide the accuracy and confidence you need to win big.
                      </p>
                  </div>
                  <div className="col-lg-4 col-12">
                      <div className="row mb-4">
                          <div className="d-grid gap-2 col-8 mx-auto">
                              <a href="/free-vip-tips-today" className="btn btn-warning" style={{fontWeight: "bold"}} type="button">VIP PACKAGES</a>
                          </div>
                      </div>
                      <div className="row mb-4">
                          <div className="d-grid gap-2 col-8 mx-auto">
      ...
      <div className="container">
            ...
            <p>
                Our tips are data-based so that you can bet with confidence. We provide our users with free winning tips for today’s matches. Additionally, we have a VIP package that will significantly transform how you bet. Once you subscribe to the <a href="https://freewinningtips.com/free-vip-tips-today" target="_blank" rel="noopener noreferrer">VIP/premium package</a>, you’ll get exclusive tips and predictions conveniently delivered to your phone. Subscribe now to get winning tips today.
            </p>
