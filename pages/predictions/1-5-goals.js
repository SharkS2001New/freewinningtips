...
export default function Over15Goals() {
  const router = useRouter();  
  const [gamesfixtures, setGames] = useState([]); //defined as an array 
  let todays_date = getFormattedCurrentDate();  
  
  let fetch_url = "https://api.pitchpredictions.com/api/fetch_under_over15_free_winning_tips?fixture_date="+todays_date;
    ...
    <div className="free-tips-section">
      ...
      <div className="row mb-4">
        <div className="col-lg-12">         
          ...
          <FreeFixturesDisplayTable gamesfixtures={gamesfixtures} url={router.pathname.substring(1)} title="1.5 Goals Predictions"/>
        </div>
      </div>
