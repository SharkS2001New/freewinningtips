...
export async function getServerSideProps() {
  ...
  try {
    ...
    const url = `https://develop.pitchpredictions.com/api/fetch_under_over15_free_winning_tips?fixture_date=${fetchDate}`;
    ...
    console.error('[over15-page] getServerSideProps error:', err.message);
