...
import SportpesaMegaPageContent from '@/components/seo-content/sportpesa-mega-jackpot-predictions-content';

export default function SportpesaMegaJackpot({ fixtures, jackpotData }) {
  return (
    <React.Fragment>
...
export async function getServerSideProps() {
  ...
  const url = `https://api.alljackpotpredictions.com/api/fetch_jackpot_fixtures_by_name?jackpot_name=${encodeURIComponent("Sportpesa Mega Jackpot")}`;
