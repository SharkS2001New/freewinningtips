    ...
    <div className="jackpot-tips-section">
      {jackpotTips.length > 0 ? (
        ...
        <div className="floating-card">
            ...
            <li><span className="bullet">1:</span> To Get Premium Winning {formatJackpotNameFromURL(router.pathname)} Tips: <b>Pay KES 90</b></li>
            ...
            {showAllSteps && (
                ...
                <li><span className="bullet">5:</span> Enter the amount <b>KES 90 and confirm (ALPAC SOFTWARE SOLUTIONS)</b></li>
