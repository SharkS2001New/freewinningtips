...
export default function SpecificJackpotPred({ fixtures, jackpotData }) {
  return (
    <JackpotFixturesTable 
      fixtures={fixtures}
      jackpotName="Sportpesa Midweek Tanzania Jackpot"
...
export async function getServerSideProps() {
  ...
  const url = `https://api.alljackpotpredictions.com/api/fetch_jackpot_fixtures_by_name?jackpot_name=${encodeURIComponent("Sportpesa Midweek Tanzania Jackpot")}`;
