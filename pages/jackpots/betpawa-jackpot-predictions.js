...
export default function SpecificJackpotPred({ fixtures, jackpotData }) {
  return (
    <JackpotFixturesTable 
      fixtures={fixtures}
      jackpotName="Betpawa Pick13 Jackpot"
...
export async function getServerSideProps() {
  ...
  const url = `https://api.alljackpotpredictions.com/api/fetch_jackpot_fixtures_by_name?jackpot_name=${encodeURIComponent("Betpawa Pick13 Jackpot")}`;
