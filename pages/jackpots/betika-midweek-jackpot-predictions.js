...
import BetikaMidweekPageContent from '@/components/seo-content/betika-midweek-jackpot-predictions-content copy';
import { getJackpotServerHeaders } from '@/components/functions/apiConfig';

export default function BetikaMidweekJackpot({ fixtures, jackpotData }) {
  return (
    <React.Fragment>
...
export async function getServerSideProps() {
  ...
  const url = `https://api.alljackpotpredictions.com/api/fetch_jackpot_fixtures_by_name?jackpot_name=${encodeURIComponent("Betika Midweek Jackpot")}`;
